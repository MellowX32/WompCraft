...
public enum ModArmorMaterials implements ArmorMaterial {
    ORBARM("orbarm", 26, new int[]{ 6, 9, 7, 6}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 1f, 0f, () -> Ingredient.of(Items.NETHERITE_INGOT));
    ...
    private static final int[] BASE_DURABILITY = { 11, 16, 15, 11};
    ...
    public String getName() {
        return WompCraft.MOD_ID + ":" + this.name;
    }
